    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <p className="sub--title">Published Articles from Medium</p>
          <h2 className="section--heading">My Articles</h2>
        </div>
        <div>
          <a href="https://github.com/Yanirw" target="_blank" rel="noopener noreferrer">
